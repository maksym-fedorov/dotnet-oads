...
& "$openSSLPath\openssl.exe" pkcs12 -export -inkey "$outputPath\certificate.key" -in "$outputPath\certificate.cer" -out "$outputPath\certificate.pfx" -passout pass:OFFICE_ADDIN_DEV_SERVER